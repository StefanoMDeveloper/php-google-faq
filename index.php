...
$array = [
    ...
    [
        ...
        "risposta" => "<span id='lista'>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</span><br><br>
        <ol>
            <li>
    ...
    [
        ...
        "risposta" => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.<br><br>
...
<body>
    <div class="container">
        ...
        foreach ($array as $elemento) {
            echo "<h2>" . $elemento["domanda"] . "</h2>" . "<p>" . $elemento["risposta"] . "</p>";
        }
        ?>
    </div>
</body>
